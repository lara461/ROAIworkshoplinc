...
export default function PresentationView({ workshopId }: { workshopId: string }) {
  ...
  if (!workshop) {
    return (
      <div className="min-h-screen bg-[#140F2D] flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {challenge && (
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <p className="text-[#FF6B4A] text-xs font-bold uppercase tracking-widest mb-2">The challenge</p>
          ...
          {solution && (
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <p className="text-[#FF6B4A] text-xs font-bold uppercase tracking-widest mb-2">Their initial answer</p>
          ...
          {board && (
            <div>
              <p className="text-[#FF6B4A] text-xs font-bold uppercase tracking-widest mb-3 text-center">The board challenges them</p>
          ...
          {board && solution?.revisedSolution && (
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <p className="text-[#FF6B4A] text-xs font-bold uppercase tracking-widest mb-2">Their revised answer</p>
          ...
          {solution?.actionsSubmitted && (
            <div>
              <p className="text-[#FF6B4A] text-xs font-bold uppercase tracking-widest mb-3 text-center">Their 30 / 60 / 90-day actions</p>
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                  <div className="text-[#FF6B4A] font-bold text-xs uppercase tracking-widest mb-1">30 days</div>
                  <div className="text-white whitespace-pre-wrap">{solution.action30}</div>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                  <div className="text-[#FF6B4A] font-bold text-xs uppercase tracking-widest mb-1">60 days</div>
                  <div className="text-white whitespace-pre-wrap">{solution.action60}</div>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                  <div className="text-[#FF6B4A] font-bold text-xs uppercase tracking-widest mb-1">90 days</div>
