...
export default function PresentationView({ workshopId }: { workshopId: string }) {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E2A] px-10 py-10">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {challenge && (
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <p className="text-[#E8503A] text-xs font-bold uppercase tracking-widest mb-2">The challenge</p>
          ...
          {board && (
            <div>
              <p className="text-[#E8503A] text-xs font-bold uppercase tracking-widest mb-3 text-center">The board challenges them</p>
